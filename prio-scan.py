#!/usr/bin/env python
__author__ = 'Sebastian Yoma Q. <sebastian@priocyber.com>'

'''
Tool para realizar scanning y obtener banner en caso de que el
servicio se encuetre abierto sobre ElasticSearch

Nota: todo puede ser mejorado, y compartir es bueno !
'''
...
def send_mail(message):
	...
	server = smtplib.SMTP('40.96.35.226:587')
	server.ehlo()
	server.starttls()
				...
				<tr>
					<td width="50%" style="padding: 4px">
						<span>
							Gerencia O&M
							<hr>
							Subgerencia de Seguridad Telco
						</span>
					</td>
					<td>
						<span>
...
html_footer = """\
		...
		<span style="font-size: 8pt; font-family: Arial; color: rgb(139, 139, 139);">
			Entel &copy; 2016 - Prohibida su reproducci&oacute;n total o parcial a trav&eacute;s de cualquier medio impreso o electr&oacute;nico.
		</span>
		<br />
		<span style="font-size: 8pt; font-family: Arial; color: rgb(139, 139, 139);">
			Informe de Seguridad
			<a href="http://www.priocyber.com/">www.priocyber.com</a>
			<a href="mailto:info@priocyber.com">PRIOCYBER COMPANY</a>
		</span>
	</body>
</html>
"""
